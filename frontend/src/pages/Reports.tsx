  ...
  return (
    <div className="fade-in">
      ...
      <div className="stats-grid">
        ...
        <div className="stat-card"><div className="stat-icon success">💰</div><div className="stat-info"><h3>{formatCurrency(report.summary.totalValue)}</h3><p>Total Inventory Value</p></div></div>
